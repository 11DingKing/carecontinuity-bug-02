...
import (
	...
	"carecontinuity/internal/continuity/maternalvisits"
)

func TestMaternalVisitDeadlinePublicBehavior(t *testing.T) {
	coordinator := maternalvisits.NewCoordinator()
